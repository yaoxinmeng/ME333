...
while ~has_quit
    ...
    fprintf('     d: Dummy Command    x: Dummy Command(sum)\n     q: Quit\n');
    ...
    switch selection
        ...
        case 'x'                         % sample sum operation
            n1 = input('Enter number 1: '); % get the number to send
            n2 = input('Enter number 2: '); % get the number to send
            fprintf(mySerial, '%d %d\n',[n1,n2]); % send the numbers
