...
static volatile int Eint = 0;         // Integral of error
...
void current_PI(int reference, int actual){
  ...
  Eint = Eint + e / 5;            // add error every 0.2ms, measured in microCoulumbs
  u = gains.Kp * e + gains.Ki * Eint;     // raw control signal
